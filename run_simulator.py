...
varients.append({"step": step, "config": "boxworld_mobile_nodes", "values": [25, 50, 75, 100, 150, 200]})
...
varients.append({"step": step, "config": "edge_selector", "values": ["dql"]})
varients.append({"step": step, "config": "mobile_selector", "values": ["dql"]})
varients.append({"step": step, "config": "boxworld_mobile_nodes", "values": [50, 100]})
varients.append({"step": step, "config": "task_generator_lambda", "values": [0.25, 0.5, 0.75, 1, 1.25]})
