...
class BoxWorldv3(EdgeNodePlug, MobileNodePlug):
    ...
    def defaultRewards(self):
        edgeRewardFunction: Callable[[
            Transition], float] = lambda transition: - BoxWorldv3.delay_coefficient * transition.delay
        mobileRewardFunction: Callable[[Transition], float] = (lambda transition: - BoxWorldv3.delay_coefficient * transition.delay
                                                               - BoxWorldv3.power_coefficient * transition.powerConsumed)
